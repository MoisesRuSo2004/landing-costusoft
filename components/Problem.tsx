    ...
    <section className="section-padding relative overflow-hidden bg-[#F9FAFB]">
      ...
      <div className="container-landing relative z-10">
        ...
        <div className="text-center mb-14">
          <div className="badge badge-cyan inline-flex mb-4">El problema real</div>
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 tracking-tight mb-4">
            Los talleres pierden dinero{" "}
            <br className="hidden sm:block" />
            <span className="gradient-text">que no saben que están perdiendo</span>
          </h2>
          <p className="text-gray-500 max-w-xl mx-auto text-[15px] leading-relaxed">
            Sin datos en tiempo real, cada decisión de producción es una apuesta.
            CostuSoft convierte incertidumbre en precisión.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-7 border border-red-100 shadow-sm">
            <div className="flex items-center gap-2.5 mb-6">
              ...
              <span className="font-semibold text-red-600">Sin CostuSoft</span>
            </div>
          ...
          {/* After */}
          <div className="bg-white rounded-2xl p-7 border border-green-100 shadow-sm relative overflow-hidden">
            <div
            ...
            <div className="flex items-center gap-2.5 mb-6">
              ...
              <span className="font-semibold text-green-700">Con CostuSoft</span>
            </div>
            <ul className="flex flex-col gap-3.5">
              {after.map((item) => (
                <li key={item} className="flex items-start gap-3">
